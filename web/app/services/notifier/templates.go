...
import (
	"syslog-web/api/telegram/bot" // Ajuste este import caso o nome do seu módulo no go.mod seja diferente
	"syslog-web/app/services/mailer"   // Ajuste este import caso o nome do seu módulo no go.mod seja diferente
)
